...
export default function Home() {
  ...
  const [shoppingList, setShoppingList] = useState(new Map<string,Ingredient>());
  ...
  const removeFromShoppingList = (itemId) => {
    setShoppingList(prev => { const newList = new Map(prev); newList.delete(itemId); return newList;});
  };
  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <RecipeManagement addRecipe={(recipe: Recipe) => setRecipes(prev => [...prev, recipe])} />
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <MealPlan mealPlan={mealPlan} replaceRecipe={function (index: number): void {
            throw new Error('Function not implemented.');
        } } />
        </div>
        <ShoppingList shoppingList={shoppingList} removeFromShoppingList={removeFromShoppingList} />
      </main>
