...
describe('parseContents', () => {
  it('should parse CSV file correctly with test fixture', async () => {
    ...
    expect(firstRecipe.ingredients).toBe('Chicken Breast, Fajita Seasoning, Guacamole, Peppers, Red Onion, Salsa, Soured Cream, Tortillas')
    ...
    const frenchToastRecipe = result.find(recipe => recipe.name === 'French toast with bacon')
